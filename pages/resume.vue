      ...
      <div class="resume-container text-sm">
        ...
        <div>
          ...
          <div class="sm:flex justify-between">
            <div>
              <h2 class="text-3xl font-bold tracking-widest text-primary">
                Hasibur Rahman
              </h2>
            ...
            <div>
              <ul class="sm:border-l sm:pl-6 sm:mt-0 mt-6 text-gray-600">
                <li class="mb-1">
                  ...
                  ></font-awesome-icon>
                  <a class="underline" href="tel:+8801 580 919 000"
                    >+8801 580 919 000</a
                  >
                </li>
                <li class="mb-1">
                ...
                <li>
                  ...
                  ></font-awesome-icon>
                  <span>315/8 Ulon, Rampura</span> <br />
                  <span class="ml-6">Dhaka, Bangladesh</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="md:flex md:items-center">
            <div class="md:w-1/5">
              <img
                class="rounded-full w-36 mx-auto"
            ...
            <p class="md:w-4/5 pl-4 mt-4 md:mt-0">
              ...
              websites for curiosity and just for fun as well. And then I became
              a good web designer with HTML, CSS, and jQuery (jQuery was a
              hero!). Besides Front-end development, I also explored Backend and
              other non-web-only technologies. This passion has since lasted and
              led to my decision to work as a freelance web developer. The
              success and fun I have in this job are immense and really keep
          ...
          <div class="lg:flex mt-10">
            <!-- Left -->
            <div class="lg:w-9/12">
              <h3 class="text-xl border-l-4 pl-6 border-primary text-primary">
                Work Experiences
              </h3>

              <!-- Jara IT -->
              <h4 class="text-lg font-bold mt-5">Full-stack web developer</h4>
              <h6 class="font-thin mb-2">
                At -
                <a
              ...
              <p></p>
              <p>
                This is a very small team where I worked as a front-end
                developer. That was my first real-life working experience. They
                make templates for WordPress and some other CMS management
                systems.
              </p>
              <p>Some of the project I'have done with this team.</p>
              <ul class="list-disc pl-8 mt-4">
              ...
              <!-- Projects -->
              <h3
                class="text-xl border-l-4 pl-6 border-primary text-primary mt-10"
              >
                Projects
              </h3>

              <h4 class="text-lg font-bold mt-5 mb-2">
                Sozashop - (Inventory)
              </h4>
              <p>
                This is an Inventory management application. Our team uses
                Laravel API for backend and Nuxt JS to manage front-end. This is
                the most complecated project I'have ever done. I enjoyed and
              ...
              <p>
                This is similar to an online marketplace where a buyer can post
                their job offer and user can apply for the job. Our team uses
                Laravel API for backend and Nuxt JS to manage front-end. Here I
                learned how a marketplace actually works and manage multiple
                authenticated user.
              </p>
              ...
              <p>
                This project was made for a company who wants to grow their
                company and satisfy their clients. This project made with
                Laravel jetstream for backend admin panel Nuxt JS to manage
                front-end.
              </p>
            </div>
            ...
            <div class="lg:w-3/12 lg:pl-8 lg:ml-8 lg:border-l mt-8 lg:mt-0">
              <h3 class="text-xl border-l-4 pl-4 border-primary text-primary">
                Skills
              </h3>
              ...
              <!-- Education -->
              <h3
                class="text-xl border-l-4 pl-4 border-primary text-primary mt-8"
              >
                Education
              </h3>
              <div class="mt-3">
              ...
              <ul class="mt-3">
                <li class="mt-1">
                  Bangla <span class="text-gray-500">(Native)</span>
                </li>
                <li class="mt-1">
                  English <span class="text-gray-500">(Fluent)</span>
                </li>
                <li class="mt-1">
                  Hindi <span class="text-gray-500">(Fluent)</span>
                </li>
              </ul>
            ...
            <ul class="flex justify-center items-center">
              <li class="flex items-center text-gray-700">
                ...
                <a
                  ...
                  target="_blank"
                  class="text-xs"
                  >facebook.com/Hasibur.Rahman.web</a
                >
              </li>
