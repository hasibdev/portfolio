    ...
    <div>
        ...
        <div class="p-10">
            <div class="resume-container text-sm">
                <!-- Print container -->
                <client-only>
                    <vue-html2pdf :show-layout="true" :float-layout="false" :enable-download="true" :preview-modal="false" filename="hasibur-rahman" :paginate-elements-by-height="3000" :pdf-quality="2" pdf-format="a4" pdf-orientation="portrait" pdf-content-width="1100px" :manual-pagination="false" ref="html2Pdf">
