<template>
  <header
    id="sidebar_header"
    class="lg:relative lg:translate-x-0 absolute transform custom-scrollbar"
    :class="{ '-translate-x-full': !isSidebarOpen }"
  >
    <div class="">
      <h3 class="text-2xl text-center mt-2 mb-6 font-bold tracking-wide">
        Hasib
      </h3>
      <!-- Image -->
    ...
    <div>
      <div>
        <font-awesome-icon :icon="['fas', 'adjust']"></font-awesome-icon>
      ...
      <div class="flex justify-center items-center mt-4 cursor-pointer">
        <!-- Switch Container -->
        <div
          class="w-14 h-7 flex items-center rounded-full mx-3 px-1"
          :class="`${isDarkMode ? 'bg-primary' : 'bg-navy'}`"
